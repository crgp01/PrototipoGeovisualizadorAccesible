...
(function ($, fluid) {
    ...
    var pathToTemplates = "../../prefsEditors-master/src/explorationTool/html/";
    var pathToMessages = "../../prefsEditors-master/src/explorationTool/messages/";
    var pathToTocTemplate = "../../prefsEditors-master/src/shared/lib/infusion/components/tableOfContents/html/TableOfContents.html";

    demo.initOverviewPanel = function () {
        fluid.overviewPanel(".flc-overviewPanel", {
            resources: {
                template: {
                    href: "../../prefsEditors-master/demos/explorationTool/overviewPanelTemplate.html"
                }
            },
            strings: {
                titleBegin: "A",
    ...
    demo.initExplorationTool = function (container) {
        return gpii.explorationTool(container, {
            ...
            iframeHtml: "../../prefsEditors-master/src/explorationTool/html/SeparatedPanelFrame.html"
        });
    };
